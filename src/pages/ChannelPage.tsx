...
export function ChannelPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50">
      <Helmet>
        <title>{`${channel.name} | ASMR Channel Profile & Info`}</title>
        <meta name="description" content={`Explore the ASMR channel profile for ${channel.name}. Find details about their content category (${channel.category}), subscriber count, description, social links, and more.`} />
        <meta name="keywords" content={`ASMR, ${channel.name}, ${channel.category}, ASMRtist, channel profile, relaxation, triggers`} />
      </Helmet>
